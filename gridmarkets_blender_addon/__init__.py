...
modulesNames = ['meta_plugin.scene_exporter',
                ...
                'blender_plugin.remote_project_container.menus.upload_options',
                'blender_plugin.remote_project_container.operators.upload_project',
                'blender_plugin.remote_project_container.operators.upload_file_as_project',
                ...
                'blender_plugin.remote_project_container.operators.set_project_upload_method',
