...
UPLOAD_CURRENT_SCENE_TUPLE = (UPLOAD_CURRENT_SCENE_VALUE, UPLOAD_CURRENT_SCENE_LABEL, UPLOAD_CURRENT_SCENE_DESCRIPTION, ICON_PROJECT, 1)
...
UPLOAD_PACKED_PROJECT_TUPLE = (OPERATOR_UPLOAD_PACKED_PROJECT_ID_NAME, OPERATOR_UPLOAD_PACKED_PROJECT_LABEL, OPERATOR_UPLOAD_PACKED_PROJECT_DESCRIPTION, ICON_PROJECT, 4)
...
UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_TUPLE = (UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_VALUE, UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_LABEL, UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_DESCRIPTION, ICON_VIEWZOOM, 5)
