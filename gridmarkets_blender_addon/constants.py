...
OPERATOR_PACK_CURRENT_SCENE_LABEL = "Pack the current scene to a local folder"
...
OPERATOR_PACK_BLEND_FILE_LABEL = "Pack the blend file to a local folder"
...
OPERATOR_UPLOAD_PACKED_PROJECT_LABEL = "Upload a packed project"
...
PACK_CURRENT_SCENE_TUPLE = (OPERATOR_PACK_CURRENT_SCENE_ID_NAME, OPERATOR_PACK_CURRENT_SCENE_LABEL, OPERATOR_PACK_CURRENT_SCENE_DESCRIPTION, ICON_PROJECT, 2)
PACK_BLEND_FILE_TUPLE = (OPERATOR_PACK_BLEND_FILE_ID_NAME, OPERATOR_PACK_BLEND_FILE_LABEL, OPERATOR_PACK_BLEND_FILE_DESCRIPTION, ICON_PROJECT, 3)
UPLOAD_PACKED_PROJECT_TUPLE = (OPERATOR_UPLOAD_PACKED_PROJECT_ID_NAME, OPERATOR_UPLOAD_PACKED_PROJECT_LABEL, OPERATOR_UPLOAD_PACKED_PROJECT_DESCRIPTION, ICON_PROJECT, 3)
...
UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_TUPLE = (UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_VALUE, UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_LABEL, UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_DESCRIPTION, ICON_VIEWZOOM, 4)

PROJECT_ACTION_OPERATORS = (
    UPLOAD_CURRENT_SCENE_TUPLE,
    UPLOAD_PROJECT_FILES_TUPLE,
