...
UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_TUPLE = (UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_VALUE, UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_LABEL, UPLOAD_BY_MANUALLY_SPECIFYING_DETAILS_DESCRIPTION, ICON_VIEWZOOM, 2)
